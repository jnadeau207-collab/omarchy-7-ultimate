...
| Files | `files.browse` | `directory.create` / `entry.trash` / `trash.restore` | empty Recycle Bin, permanent delete, desktop Recycle icon, desktop context menu; `files.trash.manage` missing; Recycle Bin is not product-complete |
