...
| System information | none | session `system-information-inspect` leftover (`system.info.read` partial; not claim=present) | no Fabric aggregate provider; `windows-native.38` pending |
...
- Accessibility: honest missing — **omit** provider-less jump destinations. System information: session leftover visible `Settings > System information` (`windows-native.38` pending; not claim=present).
