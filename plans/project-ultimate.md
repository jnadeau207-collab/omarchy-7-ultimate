...
- Interaction grammar binds every phase: [`plans/win7-ultimate-ground-truth/07-interaction-grammar.md`](win7-ultimate-ground-truth/07-interaction-grammar.md).
...
- Window chrome / Aero SSD: [`plans/win7-ultimate-ground-truth/01-window-chrome.md`](win7-ultimate-ground-truth/01-window-chrome.md).
- Superbar / taskbar (gate-adjacent): [`plans/win7-ultimate-ground-truth/03-superbar-taskbar.md`](win7-ultimate-ground-truth/03-superbar-taskbar.md).
...
- Same-path typed verbs and principals follow [`plans/win7-ultimate-ground-truth/07-interaction-grammar.md`](win7-ultimate-ground-truth/07-interaction-grammar.md).
- Index: [`plans/WIN7_SPEC_INDEX.md`](WIN7_SPEC_INDEX.md).
...
- Chrome metrics and token pipeline bind to [`plans/win7-ultimate-ground-truth/01-window-chrome.md`](win7-ultimate-ground-truth/01-window-chrome.md) (Caption LOCK in Phase 1; do not ship a 22 px title bar).
- Interaction / density / motion: [`plans/win7-ultimate-ground-truth/07-interaction-grammar.md`](win7-ultimate-ground-truth/07-interaction-grammar.md).
- Index: [`plans/WIN7_SPEC_INDEX.md`](WIN7_SPEC_INDEX.md).
...
- Start menu: [`plans/win7-ultimate-ground-truth/02-start-menu.md`](win7-ultimate-ground-truth/02-start-menu.md).
...
- Superbar / taskbar: [`plans/win7-ultimate-ground-truth/03-superbar-taskbar.md`](win7-ultimate-ground-truth/03-superbar-taskbar.md).
- Explorer as a desktop-surface consumer: [`plans/win7-ultimate-ground-truth/04-explorer-dialogs.md`](win7-ultimate-ground-truth/04-explorer-dialogs.md).
- Index: [`plans/WIN7_SPEC_INDEX.md`](WIN7_SPEC_INDEX.md).
...
- Control Panel: [`plans/win7-ultimate-ground-truth/05-control-panel.md`](win7-ultimate-ground-truth/05-control-panel.md) — 55 applets.
- Settings / defaults / admin / media: [`plans/win7-ultimate-ground-truth/06-settings-defaults-admin-media.md`](win7-ultimate-ground-truth/06-settings-defaults-admin-media.md).
- Index: [`plans/WIN7_SPEC_INDEX.md`](WIN7_SPEC_INDEX.md).
...
- Explorer / dialogs: [`plans/win7-ultimate-ground-truth/04-explorer-dialogs.md`](win7-ultimate-ground-truth/04-explorer-dialogs.md) — Explorer command-bar.
- Defaults / associations / media: [`plans/win7-ultimate-ground-truth/06-settings-defaults-admin-media.md`](win7-ultimate-ground-truth/06-settings-defaults-admin-media.md).
- Index: [`plans/WIN7_SPEC_INDEX.md`](WIN7_SPEC_INDEX.md).
...
- Programs / defaults surface bind to [`plans/win7-ultimate-ground-truth/06-settings-defaults-admin-media.md`](win7-ultimate-ground-truth/06-settings-defaults-admin-media.md).
- Index: [`plans/WIN7_SPEC_INDEX.md`](WIN7_SPEC_INDEX.md).
...
- Interaction grammar still binds: [`plans/win7-ultimate-ground-truth/07-interaction-grammar.md`](win7-ultimate-ground-truth/07-interaction-grammar.md).
...
- Control Panel: [`plans/win7-ultimate-ground-truth/05-control-panel.md`](win7-ultimate-ground-truth/05-control-panel.md) — 55 applets.
- Admin / media jobs: [`plans/win7-ultimate-ground-truth/06-settings-defaults-admin-media.md`](win7-ultimate-ground-truth/06-settings-defaults-admin-media.md).
...
- Full interaction grammar: [`plans/win7-ultimate-ground-truth/07-interaction-grammar.md`](win7-ultimate-ground-truth/07-interaction-grammar.md).
- Window chrome: [`plans/win7-ultimate-ground-truth/01-window-chrome.md`](win7-ultimate-ground-truth/01-window-chrome.md) (Caption LOCK remains Phase 1; visual top NC = 30).
- Start: [`plans/win7-ultimate-ground-truth/02-start-menu.md`](win7-ultimate-ground-truth/02-start-menu.md).
- Superbar: [`plans/win7-ultimate-ground-truth/03-superbar-taskbar.md`](win7-ultimate-ground-truth/03-superbar-taskbar.md).
- Explorer / dialogs: [`plans/win7-ultimate-ground-truth/04-explorer-dialogs.md`](win7-ultimate-ground-truth/04-explorer-dialogs.md).
- Control Panel: [`plans/win7-ultimate-ground-truth/05-control-panel.md`](win7-ultimate-ground-truth/05-control-panel.md).
- Settings / defaults / admin / media: [`plans/win7-ultimate-ground-truth/06-settings-defaults-admin-media.md`](win7-ultimate-ground-truth/06-settings-defaults-admin-media.md).
- Index: [`plans/WIN7_SPEC_INDEX.md`](WIN7_SPEC_INDEX.md).
