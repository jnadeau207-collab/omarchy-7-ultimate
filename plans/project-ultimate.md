...
| Input / Language | `input.inspect` | session `input-keyboard-layout` leftover (`input.keyboard-layout.set` partial; not claim=present) | pointer / repeat / locale; `parity.language-locale` prototype; `windows-native.33` pending |
