...
**FULL CORPUS:** link targets are the expanded `0N-*.md` packs (not digests). Start+Superbar live in `02-start-superbar.md`; interaction bible is `05-interaction-polish.md`.
...
- Links: `WIN7_SPEC_INDEX.md`, `plans/win7-ultimate-ground-truth/05-interaction-polish.md` (global metrics), `plans/win7-ultimate-ground-truth/01-window-chrome.md`
...
- Links: `plans/win7-ultimate-ground-truth/05-interaction-polish.md`, all `01`–`06` ground-truth files, `WIN7_SPEC_INDEX.md`
