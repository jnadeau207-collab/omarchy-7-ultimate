...
| Power Options | `Microsoft.PowerOptions` | Settings → Power; Superbar/QS Power | `parity.power-options` prototype; `power.inspect` + `power.profile.set` | `power.provider` (session-operable writer) |
