...
| **6** | Files and defaults | Dolphin/This PC, desktop files, graphical txt editor, MIME defaults, removable media, SMB. | **Not closed.** Product Files prototype (parity: rename/cut/copy/paste/column resize/open-in-handler absent). |
