...
- [`plans/AERO_LOCK.md`](plans/AERO_LOCK.md) - **locked OS visual standard.** Files/Settings Aero CSD (`AeroWindowChrome.qml`) is what Windows 7 looks like; every product window and the Superbar must be compatible. Do not restore hyprbars as the Explorer caption.
