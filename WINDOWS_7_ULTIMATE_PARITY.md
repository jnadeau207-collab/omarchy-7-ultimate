...
| Language / locale | prototype | Heritage `omarchy.keyboard-layout` loads in the Superbar cluster and shows only when a keyboard has more than one layout. Settings Input remains the Fabric inspect page; typed layout writers remain Phase 5. Forty-task "Change keyboard layout" pending. |
