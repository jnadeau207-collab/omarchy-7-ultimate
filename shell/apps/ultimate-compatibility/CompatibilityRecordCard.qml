...
Rectangle {
  ...
  Accessible.name: String(record.title || record.id || "Compatibility record")
  ...
  ColumnLayout {
    ...
    Rectangle {
      ...
      Accessible.name: "Compatibility evidence for " + String(root.record.title || root.record.id || "record")
      ColumnLayout {
        id: details
        anchors.fill: parent
