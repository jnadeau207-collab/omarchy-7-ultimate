...
| `defaults-mime-set` | none | write plane reachable (`defaults.mime.set`, risk `low`; catalog claim=partial; humanRoute planned empty; Settings does not offer MIME LIVE CONTROL; MIME / Default Programs association UI residual OPEN after PR #62) |
